...
- Consider adding your picture to Slack and GitHub
- Check your email for an invitation to the course GitHub organization, and join
...
- `pt-01`: Locate the project on RStudio Cloud, make a copy, complete the exercises
- `pt-02`: Locate the repository on GitHub, and then...
